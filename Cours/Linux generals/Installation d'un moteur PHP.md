...
sudo apt update
sudo apt install php7.4 php7.4-fpm php7.4-cli php7.4-mysql php7.4-curl php7.4-mbstring -y
sudo apt install php8.2 php8.2-fpm php8.2-cli php8.2-mysql php8.2-curl php8.2-mbstring -y
...
nameserver 172.16.0.1               # ATTENTION : Le fichier resolv.conf définit l'ordre de test des serveurs DNS.
